...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/meghnapamula/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/meghnapamula/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/meghnapamula/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/meghnapamula/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/meghnapamula/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/meghnapamula/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |   8m34.904s                        |   0m4.117s                        | 
| `pg_normalized_batch`  |   3m8.757s                        |    0m4.092s                       | 
| `pg_denormalized`      |   0m17.381s                        |   0m0.808s                        | 
